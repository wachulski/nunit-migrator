...
public class TestClass
{
    ...
    void MyExceptionHandler(System.Exception exception) {}
        ...
        [Test]
        public void RegionsArePreserved_ExpectedExceptionAttributeBelowTest()
        {
            var source = @"
using NUnit.Framework;
using System;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public void RegionsArePreserved_ExpectedExceptionAttributeAboveTest()
        {
            var source = @"
using NUnit.Framework;
using System;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public void CommentsArePreserved_ExpectedExceptionAttributeBelowTest()
        {
            var source =@"
using NUnit.Framework;
using System;
...
public class TestClass
{
    ...
    public void TestMethod()
    {
        ...
        [Test]
        public void CommentsArePreserved_ExpectedExceptionAttributeAboveTest()
        {
            var source = @"
using NUnit.Framework;
using System;
...
";
        ...
        [Test]
        public void CommentsArePreserved_ExpectedExceptionAttributeBelowTest_Complex1()
        {
            var source = @"
using NUnit.Framework;
using System;
...
public class TestClass
{
    ...
    public void TestMethod( string input )
    {
        ...
        [Test]
        public void CommentsArePreserved_ExpectedExceptionAttributeAboveTest_Complex1()
        {
            var source = @"
using NUnit.Framework;
using System;
